...
export function ProductDetailsPage() {
  ...
  return <>
    ...
    <PageHeader
      ...
      actions={<>{session.permissions.canManageInventory && <><Link className="button button--primary" to={`/app/products/${product.id}/edit`}>Editar producto</Link><Link className="button button--secondary" to={`/app/products/${product.id}/movements/new`}>Registrar movimiento</Link></>}{session.permissions.canDeleteInventory && <Link className="button button--danger" to={`/app/products/${product.id}/archive`}>Archivar producto</Link>}</>}
    />
