...
export function LocationDetailsPage() {
  ...
  return <>
    ...
    <PageHeader title={location.name} description={`Código: ${location.code}`} actions={<>{session.permissions.canDeleteInventory && <Link className="button button--primary" to={`/app/locations/${location.id}/edit`}>Editar ubicación</Link>}{session.permissions.canDeleteInventory && location.status === "active" && !location.isDefault && <><Link className="button button--secondary" to={`/app/locations/${location.id}/make-default`}>Convertir en principal</Link><Link className="button button--danger" to={`/app/locations/${location.id}/deactivate`}>Desactivar</Link></>}{session.permissions.canDeleteInventory && location.status === "inactive" && <Link className="button button--primary" to={`/app/locations/${location.id}/reactivate`}>Reactivar</Link>}</>} />
